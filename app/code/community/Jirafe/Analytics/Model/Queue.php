...
class Jirafe_Analytics_Model_Queue extends Jirafe_Analytics_Model_Abstract
{
    ...
    /**
     * Process queue of records via cron or direct call
     ...
     * @throws Exception if unable to process queue
     */
     ...
     * @return boolean
     * @throws Exception if unable to update jirafe_analytics_queue
     */
    
    public function updateQueue( $attempt = null )
    {
        try {
            if ($attempt) {
