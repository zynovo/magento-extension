        ...
        try {
            if ($quote) {
                ...
                $data = array(
                    ...
                    'total_tax' => $this->_formatCurrency( 0 ),
                    'total_shipping' => $this->_formatCurrency( 0 ),
                    'total_payment_cost' => $this->_formatCurrency( $quote->getData('grand_total') ),
                    'total_discounts' => $this->_formatCurrency( 0 ),
