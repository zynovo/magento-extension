        ...
        try {
            if ($orderId) {
                ...
                $collection = Mage::getModel('sales/order_item')
                    ->getCollection()
                    ->getSelect()
                    ->joinLeft(array('parent'=>Mage::getSingleton('core/resource')->getTableName('sales/order_items')), "main_table.parent_item_id = parent.item_id")
                    ->joinLeft(array('option'=>Mage::getSingleton('core/resource')->getTableName('sales/order_items_option')), "parent.item_id = option.item_id AND option.code = 'attributes'",array('option.value'))
