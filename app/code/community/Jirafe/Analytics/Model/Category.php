...
class Jirafe_Analytics_Model_Category extends Jirafe_Analytics_Model_Abstract
{
    ...
    public function getArray( $category = null ) 
    {
        try {
            ...
            Mage::helper('jirafe_analytics')->log('ERROR', 'Jirafe_Analytics_Model_Category::getArray()', $e->getMessage());
            return false;
        }
    }
    ...
    public function getHistoricalData( $startDate = null, $endDate = null )
    {
        try {
            ...
            Mage::helper('jirafe_analytics')->log('ERROR', 'Jirafe_Analytics_Model_Category::getHistoricalData()', $e->getMessage());
            return false;
        }
    }
}