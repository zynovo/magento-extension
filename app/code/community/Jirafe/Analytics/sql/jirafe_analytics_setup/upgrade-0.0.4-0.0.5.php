...
$installer->run("
    ...
    INSERT INTO {$this->getTable('jirafe_analytics/map')} (`object`,`key`,`api`,`magento`,`type`) VALUES 
        ...
        ('customer', 'id', 'active_flag', 'is_active', 'boolean'),
        ('customer', 'id', 'change_date', 'created_at', 'datetime'),
        ('customer', 'id', 'create_date', 'updated_at', 'datetime'),
        ('customer', 'id', 'email', 'email', 'string'),
        ('customer', 'id', 'first_name', 'firstname', 'string'),
        ('customer', 'id', 'last_name', 'lastname', 'string'),
        ('customer', 'id', 'id', 'entity_id', 'int'),
        ('employee', 'id', 'active_flag', 'is_active', 'boolean'),
        ('employee', 'id', 'change_date', 'created_at', 'datetime'),
        ('employee', 'id', 'create_date', 'updated_at', 'datetime'),
        ('employee', 'id', 'email', 'email', 'string'),
        ('employee', 'id', 'first_name', 'firstname', 'string'),
        ('employee', 'id', 'last_name', 'lastname', 'string'),
